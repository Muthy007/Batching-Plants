      ...
      <Box>
        ...
        <Box p={2}>
          <Tabs
            ...
            textColor="primary"
          >
            <Tab label="Open Quotes" sx={{ fontSize: "1.2rem" }} />
            <Tab label="All Quotes" sx={{ fontSize: "1.2rem" }} />
          </Tabs>
          {selectedTab === 0 && (
            <>
              {quoteTable.length > 0 ? (
                      ...
                      {quoteTable &&
                        quoteTable.map((item, index) => (
                          <TableRow
                            ...
                            onClick={() =>
                              navigate(
                                `/Sales/QuoteAccept?organisationId=${organisationId}&organisation=${organisation}&customerId=${customerId}`,
                                {
                                  state: { item },
                                }
                              )
