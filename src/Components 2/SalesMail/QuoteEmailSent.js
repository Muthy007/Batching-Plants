...
const QuoteEmailSent = ({ onLogout }) => {
  ...
  const { isQuote, data } = location.state || {};
  ...
  const url = `https://erp-api.schwingcloud.com/Service1.svc/getEmailDetails?organization_id=${orgid}&type=quote&user=${user}`;
    ...
    axios
      .get(url, {
        headers: {
          ...
          id: isQuote === true ? data[0].id : data.id,
        },
      })
      .then((res) => {
        ...
        if (JSON.parse(res.data).Code === 1) {
          ...
          setSubject(
            `Quote from ${userData[0] ? userData[0].org_name : ""} (Quote#: ${
              JsonData[0] ? JsonData[0].quote_no : ""
            }) is ready to view`
          );
  ...
  const getQuoteDetails = () => {
    const params = {
      ...
      type: "2",
      quote_ids: [isQuote === true ? data[0].id : data.id],
      user: user,
      org_id: orgid,
              ...
              >
                  ...
                  <tbody>
                    ...
                    >
                      <td colSpan="3" style={{ paddingBottom: "5px" }}>
                        {userData[0]
                          ? userData[0].state_name +
                            ", " +
                            userData[0].country_name
                          : ""}
                        <br />
                    ...
                    <tr style={{ border: "2px solid #ddd" }}>
                      ...
                      >
                        {"Quote#" +
                          "           " +
                          `: ${
                            quoteDetails[0] ? quoteDetails[0].quote_no : ""
                          }`}
                        <br />
                        {"Date " +
                          "              " +
                          `: ${
                            quoteDetails[0] ? quoteDetails[0].quote_date : ""
                          }`}
                        <br />
                        {"Reference#" +
                          "     " +
                          `: ${
                            quoteDetails[0] ? quoteDetails[0].reference : ""
                          }`}
                      </td>
                      <td
                        colSpan="2"
                      ...
                      >
                        {"Place of supply" +
                          "         " +
                          `: ${
                            quoteDetails[0] ? quoteDetails[0].plc_supply : ""
                          }`}
                      </td>
                    </tr>
                    <tr
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ textAlign: "right", paddingRight: "5px" }}>
                        {/* Format the amount with currency symbol */}₹
                        {Number(
                          quoteDetails[0] ? quoteDetails[0].sub_total : ""
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "right", paddingRight: "5px" }}>
                        {/* Format the amount with currency symbol */}₹
                        {Number(
                          quoteDetails[0] ? quoteDetails[0].ship_charge : ""
                        ).toLocaleString("en-IN")}
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: "right", paddingRight: "5px" }}>
                        {/* Format the amount with currency symbol */}₹
                        {Number(
                          quoteDetails[0] ? quoteDetails[0].adjustment : ""
                        ).toLocaleString("en-IN")}
                      </td>
                    </tr>
                    <tr>
                ...
                <div style={{ marginTop: "20px" }}>
                  <p style={{ fontWeight: "bold", marginBottom: "5px" }}>
                    Total in Words:{" "}
                    {quoteDetails[0]
                      ? convertToWordsWithoutDecimal(quoteDetails[0].total)
                      : ""}
                  </p>
                ...
                <div style={{ background: "#fbfbfb" }}>
                  ...
                  <div id="actualcontent">
                    ...
                    >
                      ...
                      >
                        Quote #{emailDetails[0] ? emailDetails[0].quote_no : ""}
                      </div>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      ...
                      >
                        ...
                        <br />
                        <br />
                        Thank you for contacting us. Your quote can be viewed,
                        printed, and downloaded as a PDF from the link below.
                        <br />
                      </div>
                      <div
                        style={{
                      ...
                      >
                        ...
                        >
                          <h4 style={{ marginBottom: 0 }}>QUOTE AMOUNT</h4>
