...
const DeliveryChallan = ({ onLogout }) => {
  ...
  const handleCheckboxClick = (event, id) => {
    ...
    setSelectAll(newSelected.length === deliveryTable.length);
  };
  ...
  const handleDelete = () => {
    ...
    const params = {
      json_type: "delete_delivery_challans",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {selectedItem} Delivery Challans
                    <ExpandMoreRounded
                      sx={{
                        width: 40,
                        height: 40,
              ...
              >
                ...
                >
                  ...
                  {selectedItem && deliveryTable.length === 0 && (
                    <Box
                      sx={{
                        textAlign: "center",
                        p: 20,
                    ...
                    >
                      ...
                      >
                        Currently, no delivery challans are available. Select
                        'Create New' to add a new one.
                      </Typography>
                      <Tooltip title="Create Delivery Challans" arrow>
                        <Button
                          sx={{
                            width: "200px",
                            height: 50,
                  ...
                  {deliveryTable.length > 0 &&
                    ...
                    !deliveryTable
                      ...
                      >
                        ...
                        >
                          There are no {selectedItem} Delivery Challans
                        </Typography>
                      </Box>
                    )}
                  {deliveryTable.length > 0 &&
                    deliveryTable.filter((data) =>
                      Object.values(data).some((row) =>
                        row
                          .toString()
                          .toLowerCase()
                      ...
                      >
                        ...
                        >
                          There are no Delivery Challans
                        </Typography>
                      </Box>
                    )}
                </TableContainer>
