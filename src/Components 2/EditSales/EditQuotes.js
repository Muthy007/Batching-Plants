...
const EditQuotes = ({ onLogout }) => {
  ...
  const handleSaveEditQuote = (send, setLoading) => {
    setLoading(true);
    const itemsId =
  ...
  const handleSaveDraft = () => handleSaveEditQuote(false, setIsSavingDraft);
  const handleSend = () => handleSaveEditQuote(true, setIsSavingAndSending);
